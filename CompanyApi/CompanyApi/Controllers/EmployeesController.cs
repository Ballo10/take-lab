    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<EmployeeDTO>>> GetEmployees()
        {
          if (_context.Employees == null)
          {
            ...
            return await _context.Employees.Select(employee => EmployeeToDTO(employee)).ToListAsync();
        }
        ...
        public async Task<IActionResult> PutEmployee(int id, EmployeeDTO employee)
        {
            ...
            _context.Entry(DTOToEmployee(employee)).State = EntityState.Modified;
        ...
        public async Task<ActionResult<EmployeeDTO>> PostEmployee(EmployeeDTO employee)
        {
          if (_context.Employees == null)
          {
            ...
            _context.Employees.Add(DTOToEmployee(employee));
            await _context.SaveChangesAsync();
